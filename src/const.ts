...
export const LOCATION = "더파티움!@!"
export const LOCATION_ADDRESS = "더파티움 주소가 들어갈곳"
...
export const BRIDE_FULLNAME = "송지연"
export const BRIDE_FIRSTNAME = "지연"
...
export const GROOM_FULLNAME = "기라성"
export const GROOM_FIRSTNAME = "라성"
